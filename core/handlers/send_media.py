...
async def get_audio(message: Message, bot: Bot):
    audio = FSInputFile(path=r'C:\Users\Administrator\Desktop\photo\audio.mp3', filename='AudioFile.mp3')
...
async def get_media_group(message: Message, bot: Bot):
    photo1_mg = InputMediaPhoto(type='photo',
                                media=FSInputFile(r'C:\Users\Administrator\Desktop\photo\image.jpg'),
                                caption='Its mediagroup')
    photo2_mg = InputMediaPhoto(type='photo',
                                media=FSInputFile(r'C:\Users\Administrator\Desktop\photo\sticker.png'))
    video_mg = InputMediaVideo(type='video',
                               media=FSInputFile(r'C:\Users\Administrator\Desktop\photo\Robots_video.mp4'))
...
async def get_voice(message: Message, bot: Bot):
    async with ChatActionSender.record_voice(message.chat.id):
